var ChartsChartJs = {
	...
	polarAreaChart: function () {
		...
		var ctxPolar2 = $('.chartjs-polar2').get(0).getContext("2d");
		var myPolarChart2 = new Chart(ctxPolar2).PolarArea( ChartsChartJs.polarData2() );
		// var myPolarChart = new Chart(ctxPolar).PolarArea(dataPolar);
	},
